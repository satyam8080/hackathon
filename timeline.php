...
<nav class="navbar navbar-inverse navbar-fixed-top ">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" title="Home" href="home.php">FRIENDS FEED</a>
    ...
    <ul class="nav navbar-nav" id="responsivenav">
          ...
          <li id="link1"   onclick="active_link1()"><a href="home.php">News and Feeds</a></li>
          <li id="link2" class="active" ><a href="#">Your Timeline</a></li>
 ...
 <img src="uploads/<?php echo $_SESSION['img_url']; //print_r( $img_url ); ?>" style="border-radius : 15px; width:35px;height:35px; ">    
